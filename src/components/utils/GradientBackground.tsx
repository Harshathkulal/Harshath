  ...
  return (
    <AnimationContainer>
      <div className="min-h-screen w-full bg-[#080809]">
        <div className="absolute inset-0 z-[20] bg-grid-neutral-600/20 flex"></div>

        <div className="absolute z-[20] inset-0 items-center justify-center bg-[#080809] [mask-image:radial-gradient(ellipse_at_center,transparent_5%,black)] flex"></div>
