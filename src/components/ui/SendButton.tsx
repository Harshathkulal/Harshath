    ...
    <AnimatePresence>
      <motion.button
        ...
        className={buttonVariants({
          className:
            "px-6 w-full md:w-60 cursor-pointer md:px-8 py-2 text-center overflow-hidden bg-white font-semibold rounded-md flex items-center justify-center z-20 space-x-1.5",
        })}
      >
        <span className={cn("text-neutral-900", isLoading ? "ml-0" : "ml-5")}>
